...
\begin{center}
    \textbf{\Huge \scshape Tinghao Lu} \\ \vspace{3pt}
    \small
    \faMobile \hspace{.5pt} \href{tel:08615658131822}{+86 15658131822}
    $|$
    \faAt \hspace{.5pt} \href{vinceluth@163.com}{vinceluth@163.com}
    $|$
\end{center}
...
\section{Education}
  ...
  {Master of Science in Data Science;   \textbf{GPA: 3.93/4.00}}{Sep 2020 \textbf{--} Jun 2022}
    
    \resumeSubheading
      {University of California, Santa Barbara
      }{California, Unites States}
      {Bachelor of Science in Statistical Science;   \textbf{GPA: 3.67/4.00}}{Sep 2016 \textbf{--} Mar 2020}
